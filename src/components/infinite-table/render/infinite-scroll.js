...
function InfiniteScrollerSource() {
}
...
InfiniteScroller.prototype = {
  ...
  onScroll_() {
    ...
    if (delta < 0) this.fill(this.anchorItem.index - RUNWAY_ITEMS, lastScreenItem.index + RUNWAY_ITEMS_OPPOSITE);
    else this.fill(this.anchorItem.index - RUNWAY_ITEMS_OPPOSITE, lastScreenItem.index + RUNWAY_ITEMS);
  },
  ...
  maybeRequestContent() {
    ...
    this.source_.fetch(itemsNeeded).then(this.attachContent.bind(this));
  },
